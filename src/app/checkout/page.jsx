  ...
  return (
    <>
      <div className="xl:w-[1280px] mx-auto">
        <div className="my-10 flex flex-col text-white space-y-5">
          ...
          <div className="flex flex-col md:flex-row md:space-x-6 my-10">
            <div className="basis-[70%]  flex flex-col space-y-8 ">
              ...
              <div className="flex flex-row mx-5 md:mx-0 space-x-3">
                <div className="md:basis-[38%] basis-[50%] flex flex-col  fill-white rounded-md p-5 space-y-5 bg-red-700 text-white">
                  <svg
                    width="26"
                    height="32"
                    viewBox="0 0 26 32"
                ...
                <div className="md:basis-[38%] basis-[50%] text-white fill-white hover:fill-white hover:text-white hover:bg-red-700 flex flex-col rounded-md p-5 space-y-5 border-2 border-red-700 border-dashed ">
                  <svg
                    width="26"
                    height="32"
                    viewBox="0 0 26 32"
              ...
              <h2 className="text-3xl  mx-auto md:mx-0 font-semibold">
                Payment
              </h2>
              <div className="border-2 p-5 flex flex-col space-y-5 border-gray-300 rounded-lg">
                ...
                <div className="flex flex-col space-y-3">
                  ...
                  <input
                    type="text"
                    className="outline-none w-full h-12 border-2 border-gray-300 bg-black text-white p-3 rounded-md"
                  />
                </div>
                <div className="flex flex-col space-y-3">
                  ...
                  <input
                    type="text"
                    className="outline-none w-full h-12 border-2 bg-black text-white border-gray-300 p-3 rounded-md"
                  />
                </div>
