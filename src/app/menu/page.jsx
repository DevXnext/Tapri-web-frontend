        ...
        <div className="flex md:mx-0 mx-auto flex-row items-center space-x-2 text-gray-700 font-semibold">
          ...
          <div className="grid md:grid-cols-6 grid-cols-2 justify-items-center  gap-6 py-6">
            {categories.map((category) => (
              <div
                key={category}
                className={`border-2 cursor-pointer rounded-full px-6 py-2 ${
          ...
          <div className="grid md:grid-cols-3 grid-cols-1 justify-items-center  gap-6 ">
            {filteredMenu.length > 0 ? (
              filteredMenu.map((menuItem, index) => (
                <div
                  key={index}
                  className="flex flex-col space-y-5  border-2 rounded-xl items-center"
                >
                  ...
                  <div className="flex flex-col space-y-6 p-3 bg-black text-white rounded-t-3xl ">
                    ...
                    <div className="flex flex-row justify-between items-center pb-2">
                      <p className="text-[20px] text-red-500 font-semibold">{`$ ${menuItem.price}`}</p>
                      <button className="bg-red-500 px-5 py-2 rounded-full hover:bg-red-800">
                        Order Now
                      </button>
                    </div>
                  </div>
