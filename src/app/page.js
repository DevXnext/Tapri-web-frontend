...
export default function Home() {
  ...
  const slides = [
    // Slide 1
    (
      <div className="basis-1/2 flex flex-col text-white md:space-y-16 space-y-10 py-20" key={0} >
        ...
        <div className="flex md:flex-row flex-col md:space-y-0 space-y-5 md:space-x-3 ">
          <input
            type="text"
            className="w-96 h-12 text-white bg-black border-[1px] rounded-md pl-3"
            placeholder="Search Food"
          />
          <button className="p-3 bg-red-700 border-2 text-white rounded-md hover:border-2 
    ...
    // Slide 2
    (
      <div className="flex flex-col md:space-y-16 text-white space-y-10 py-20 " key={1} >
         <h1 className="font-semibold text-6xl ">
         Walk In and Get <span className="text-red-700">15% OFF</span> On Any Food 
        </h1>
    ...
    // Slide 3
    (
      <div className="basis-1/2 flex flex-col text-white md:space-y-16 space-y-10 py-20" key={3} >
      <h1 className="font-semibold text-6xl ">
        Dive into Delights Of Delectable Food
      </h1>
      <p className="text-2xl font-medium text-gray-200">
