        ...
        <div className="flex mx-auto md:mx-0 flex-row items-center space-x-2 text-white font-semibold">
          ...
          <div className="flex md:flex-row flex-col md:space-x-16 space-x-0 md:mx-0  mx-2">
            <div>
              ...
              />
            <p className="my-2 text-white text-center">You will get 20 rewards points on this dish</p>
            </div>
            <div className="flex flex-col space-y-5 px-5 md:px-0 basis-[40%]">
              ...
              <label className="text-white text-base">Choose Level of Spiciness </label>
             <select className="h-12 bg-black px-2 rounded-lg 
             ...
             <input type="number" placeholder="1"  className="h-12 bg-black px-2 rounded-lg 
             text-white border-[1px]"/>
              </div>
              <div className="flex-col flex space-y-2">
              <label className="text-white text-base">Comment </label>
              <input type="text" placeholder="Type here..."  className="h-12 bg-black px-2 rounded-lg 
             text-white border-[1px]"/>
              </div>
             <Link href="/cart" className="text-center cursor-pointer text-white text-[18px] bg-red-700 w-full py-3 rounded-full hover:bg-red-800">Add to Cart</Link>
            </div> 
          </div>
