        ...
        <div className='home'>
            ...
            <div className='homeContainer'>
                ...
                <div className='row mx-auto'>
                    ...
                    <div className='col-md-6'>
                        <Link href="/createNewCoupon" className='btn btn-outline-dark float-right'>Create New Coupon</Link>
                    </div>
                </div>
                    ...
                    <TableContainer component={Paper} className="table">
                        <Table sx={{ minWidth: 650 }} aria-label="simple table">
                            <TableHead>
                                ...
                                <TableRow>
                                    <TableCell className="tableCell fw-bold text-center">Promo Code</TableCell>
                                    <TableCell className="tableCell fw-bold">
                                        <div className='ml-5'>Food Item</div>
                                    </TableCell>
                            ...
                            <TableBody>
                                {rows.map((row) => (
                                    <TableRow key={row.id}>
                                        <TableCell className="tableCell text-center">#321651321</TableCell>
