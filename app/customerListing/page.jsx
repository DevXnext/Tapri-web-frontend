                    ...
                    <TableContainer component={Paper} className="table">
                        <Table sx={{ minWidth: 650 }} aria-label="simple table">
                            <TableHead>
                                ...
                                <TableRow>
                                    <TableCell className="tableCell fw-bold pl-5">Customer</TableCell>
                                    <TableCell className="tableCell fw-bold text-center">Total</TableCell>
                                    <TableCell className="tableCell fw-bold text-center">Reward Points</TableCell>
                            ...
                            <TableBody>
                                {rows.map((row) => (
                                    <TableRow key={row.id}>
                                        ...
                                        <TableCell className="tableCell text-center cellDate">130</TableCell>
